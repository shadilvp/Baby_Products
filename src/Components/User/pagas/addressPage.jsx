    ...
    return (
        <div className="p-6 bg-blue-300 min-h-screen">
          ...
          <div className="text-center mb-6">
            <button
              onClick={()=>navigate('/')}
              className="bg-gray-500 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-gray-600 transition-all"
            >
              Back to Home
            </button>
          </div>
          ...
          {showForm && (
            ...
            >
              <Form className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                ...
                <button type="submit" className="bg-blue-500 text-white py-3 px-6 rounded-lg shadow-lg w-full hover:bg-blue-600 transition-all">
                  Submit
                </button>
              </Form>
            </Formik>
              ...
              {addresses && addresses.length > 0 ? (
                <ul className="space-y-4 max-w-3xl mx-auto">
                  {addresses.map((address) => (
                    <li key={address._id} className="bg-white p-6 border border-gray-300 rounded-lg shadow-md flex justify-between items-center">
                      <div className="w-3/4">
