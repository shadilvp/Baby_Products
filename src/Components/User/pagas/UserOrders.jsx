        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-10">
          <div className="w-4/5">
            ...
            {specificOrder.map((order, index) => (
              <div
                key={index}
                className="w-[65vw] bg-white p-6 rounded-lg shadow-lg mb-8 mx-auto hover:scale-[1.02] transition-transform duration-300"
              >
                {/* Address Section */}
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {order.items.map((cartItem, cartIndex) => (
                      <div
                        key={cartIndex}
                        className="flex items-center gap-6 bg-gray-50 p-4 rounded-lg shadow-md hover:scale-[1.03] transition-transform duration-300"
                      >
                        <img
